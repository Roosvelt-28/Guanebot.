...
//   pared     — color de los muros de las salas
//   techo     — color del techo
//   fondo     — color de fondo/niebla de la escena (ambiente general)
//   acento    — color de marcos, puertas doradas, guías de suelo y textos
...
export const CULTURAS = [
  {
    ...
    salas: salasGuane,
    piezas: piezasGuane,
    // Tierra y barro del cañón del Chicamocha: ocres y terracotas cálidos.
    paleta: {
      pared: 0x8B5230,
      techo: 0x2A1A0A,
      fondo: 0x1E1008,
  ...
  },
  {
    ...
    salas: salasMuisca,
    piezas: piezasMuisca,
    // Verde esmeralda del altiplano y oro de la leyenda de El Dorado.
    paleta: {
      pared: 0x2E5C4A,
      techo: 0x142A20,
      fondo: 0x0D1A14,
  ...
  },
  {
    ...
    // Turquesa y jade de la sierra, con acentos dorados de sus orfebres.
    paleta: {
      pared: 0x1E5C5C,
      techo: 0x0E2C2C,
      fondo: 0x081818,
  ...
  },
  {
    ...
    // Oro intenso: los orfebres más célebres del Museo del Oro.
    paleta: {
      pared: 0xB8860B,
      techo: 0x3D2B08,
      fondo: 0x1A1204,
  ...
  },
  {
    ...
    salas: salasCalima,
    piezas: piezasCalima,
    // Oro cálido con verdes de selva del valle del río Calima.
    paleta: {
      pared: 0x6B5B1E,
      techo: 0x2E2610,
      fondo: 0x161006,
