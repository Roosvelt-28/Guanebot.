...
//  Rutas locales (img/muisca/) para evitar el problema de CORS
//  que impedía cargar las texturas 3D (ver quimbaya.js).
//  Cada pieza incluye su fuente y URL en `det`.
// ============================================================

const FUENTE_MUISCA = 'https://enciclopedia.banrepcultural.org/index.php?title=Muisca';
const FUENTE_BALSA  = 'https://enciclopedia.banrepcultural.org/index.php?title=Balsa_muisca';
const FUENTE_MOMIA  = 'https://commons.wikimedia.org/wiki/Category:Muisca_art';
...
export const piezasMuisca = [
    // ── SALA 1: ¿Quiénes eran los Muiscas? ────────────────────────────────
    {
      ...
      foto: "img/muisca/figura-votiva-guatavita.jpg",
      ...
      det: "<span>Período:</span> Siglo VI–XVI d.C.<br><span>Territorio:</span> Cundinamarca, Boyacá, sur de Santander<br><span>Lengua:</span> Muysccubun (familia chibcha)<br><span>Pieza:</span> Figura votiva, tumbaga, Guatavita (Cundinamarca), 8 x 4,2 cm" + credito(FUENTE_MUISCA)
    },
    {
      sala: 0, lado: "L2", forma: "cuadro", escala: [4.29, 2.73],
      tag: "Historia", titulo: "Los Guane, primos de los Muiscas",
      foto: "img/muisca/nariguera-oro.jpg",
      ...
      det: "<span>Confederaciones hermanas:</span> Bacatá, Hunza, Tundama, Iraca, Guane<br><span>Familia lingüística:</span> Chibcha<br><span>Pieza:</span> Nariguera, oro, 600–1600 d.C., 14,6 x 18,9 cm, orfebrería del mismo estilo compartido por estos pueblos" + credito(FUENTE_MUISCA)
    },
    {
      sala: 0, lado: "R", forma: "cuadro", escala: [4.29, 2.73],
      tag: "Sociedad", titulo: "Organización política",
      foto: "img/muisca/pectoral-varela.jpg",
      ...
      det: "<span>Zipazgo:</span> Bacatá (Bogotá)<br><span>Zacazgo:</span> Hunza (Tunja)<br><span>Sucesión:</span> Matrilineal<br><span>Pieza:</span> Pectoral, 1080 d.C., Varela, Chiquinquirá (Boyacá), 15 x 14,5 cm, insignia de autoridad" + credito(FUENTE_MUISCA)
    },
    {
      sala: 0, lado: "R2", forma: "cuadro", escala: [4.29, 2.73],
      tag: "Sociedad", titulo: "Jerarquía social",
      foto: "img/muisca/guerreros-tiraderas.jpg",
      ...
      det: "<span>Jerarquía:</span> Zipa/Zaque → Uzaque → Chyquy → Güecha → Pueblo<br><span>Lengua viva relacionada:</span> U'wa (Tunebo)<br><span>Pieza:</span> Guerreros muiscas con tiraderas (dardos), ofrenda hallada en Tenjo (Cundinamarca)" + credito(FUENTE_MUISCA)
    },
    ...
    // ── SALA 2: Economía y comercio ───────────────────────────────────────
    {
      ...
      foto: "img/muisca/copa-ceramica.jpg",
      ...
      det: "<span>Cultivos:</span> Maíz, papa, quinua<br><span>Técnica:</span> Uso escalonado de pisos térmicos<br><span>Pieza:</span> Copa, cerámica, 600–1600 d.C., 13,5 x 18,5 cm, para consumo ritual de alimentos" + credito(FUENTE_MUISCA)
    },
    {
      sala: 1, lado: "L2", forma: "cuadro", escala: [4.29, 2.73],
      tag: "Economía", titulo: "La sal, riqueza del altiplano",
      foto: "img/muisca/figura-votiva-oro.jpg",
      ...
      det: "<span>Sitios:</span> Zipaquirá, Nemocón<br><span>Uso:</span> Consumo y moneda de intercambio<br><span>Pieza:</span> Figura votiva, oro, 600–1600 d.C., 8,4 x 2,5 cm, ejemplo de ofrenda costeada con bienes de intercambio" + credito(FUENTE_MUISCA)
    },
    {
      sala: 1, lado: "R", forma: "cuadro", escala: [4.29, 2.73],
      tag: "Economía", titulo: "Esmeraldas",
      foto: "img/muisca/diadema-oro-sogamoso.jpg",
      ...
      det: "<span>Recurso:</span> Esmeraldas<br><span>Uso:</span> Ofrenda ritual y comercio<br><span>Pieza:</span> Diadema de oro, Sogamoso (Boyacá), 6,5 x 22,8 cm, insignia donde se engastaban piedras preciosas" + credito(FUENTE_MUISCA)
    },
    {
      sala: 1, lado: "R2", forma: "cuadro", escala: [4.29, 2.73],
      tag: "Economía", titulo: "Trueque: sal y esmeraldas por oro",
      foto: "img/muisca/figura-votiva-pasca.jpg",
      ...
      det: "<span>Exportaban:</span> Sal, esmeraldas, mantas de algodón<br><span>Importaban:</span> Oro<br><span>Sistema:</span> Trueque<br><span>Pieza:</span> Figura votiva, oro, Pasca (Cundinamarca), 8,3 x 22,6 cm" + credito(FUENTE_MUISCA)
    },
    ...
    // ── SALA 3: Orfebrería y El Dorado ────────────────────────────────────
    {
      ...
      foto: "img/muisca/figura-votiva-belen-chinauta.jpg",
      ...
      det: "<span>Técnica:</span> Cera perdida<br><span>Materiales:</span> Oro, plata, cobre (tumbaga)<br><span>Función:</span> Ofrenda votiva<br><span>Pieza:</span> Figura votiva (tunjo), tumbaga, Belén de Chinauta, Fusagasugá (Cundinamarca), 9,1 x 5,7 x 6,4 cm" + credito(FUENTE_MUISCA)
    },
    {
      ...
      det: "<span>Lugar:</span> Laguna de Guatavita<br><span>Ritual:</span> Investidura del cacique<br><span>Vigente hasta:</span> 1536<br><span>Pieza:</span> Figura votiva, tumbaga, hallada en Guatavita (Cundinamarca), 8 x 4,2 cm" + credito(FUENTE_MUISCA)
    },
    {
      ...
      det: "<span>Aleación:</span> Oro + cobre (tumbaga)<br><span>Herramienta:</span> Matrices de piedra<br><span>Pieza:</span> Nariguera, oro, 14,6 x 18,9 cm" + credito(FUENTE_MUISCA)
    },
    {
      sala: 2, lado: "R2", forma: "esfera", escala: [0.65],
      tag: "Orfebrería", titulo: "La Balsa Muisca",
      foto: "img/muisca/balsa-muisca.jpg",
      ...
      det: "<span>Hallazgo:</span> 1969, Pasca (Cundinamarca)<br><span>Museo:</span> Museo del Oro, Bogotá<br><span>Técnica:</span> Cera perdida, pieza única, oro de más del 80% de ley<br><span>Medidas:</span> 19,5 x 10,1 x 10,2 cm" + credito(FUENTE_BALSA)
    },
    ...
    // ── SALA 4: Textiles y cerámica ───────────────────────────────────────
    {
      ...
      foto: "img/muisca/ofrendatario-balsa.jpg",
      ...
      det: "<span>Material:</span> Algodón (intercambiado por trueque)<br><span>Uso especial:</span> Manta roja = luto<br><span>Pieza:</span> Ofrendatario cerámico en forma de chamán sentado, hallado junto a la Balsa Muisca en Pasca (Cundinamarca)" + credito(FUENTE_BALSA)
    },
    {
      ...
      det: "<span>Enseñanza:</span> Hilar y tejer algodón<br><span>Otros nombres:</span> Nemqueteba, Xué, Sadigua, Sugumonxe<br><span>Pieza:</span> Figura votiva, oro, 8,4 x 2,5 cm" + credito(FUENTE_MUISCA)
    },
    {
      ...
      det: "<span>Usos:</span> Doméstico y ritual<br><span>Decoración:</span> Motivos geométricos<br><span>Pieza:</span> Copa, cerámica, 13,5 x 18,5 cm" + credito(FUENTE_MUISCA)
    },
    {
      sala: 3, lado: "R2", forma: "cuadro", escala: [4.29, 2.73],
      tag: "Ritual", titulo: "El poporo y la hoja de coca",
      foto: "img/muisca/momia-pisba.jpg",
      desc: "El poporo, un calabazo que guardaba cal, se usaba junto con hojas de coca en un ritual de mambeo asociado al estatus y a la vida ceremonial. Con esta momia muisca hallada en Pisba (Boyacá) se encontró su propio poporo, junto con copas de cerámica ritual, un tunjo y una mochila tejida.",
      det: "<span>Objeto:</span> Poporo (calabazo con cal)<br><span>Uso:</span> Mambeo ritual de hoja de coca<br><span>Pieza:</span> Momia muisca hallada en un páramo de Pisba (Boyacá), período colonial, exhibida en el Museo del Oro" + credito(FUENTE_MOMIA)
    },
    ...
    // ── SALA 5: Religión y mitología ──────────────────────────────────────
    {
      ...
      det: "<span>Rol:</span> Dios creador supremo<br><span>Hijos/dioses menores:</span> Sué, Chía, Chaquén<br><span>Pieza:</span> Diadema de oro, Sogamoso (Boyacá), 6,5 x 22,8 cm, insignia religiosa" + credito(FUENTE_MUISCA)
    },
    {
      ...
      det: "<span>Dios castigador:</span> Chibchacum (lluvia y trueno)<br><span>Dios salvador:</span> Bochica<br><span>Pieza:</span> Pectoral, 1080 d.C., Varela, Chiquinquirá (Boyacá), 15 x 14,5 cm" + credito(FUENTE_MUISCA)
    },
    {
      ...
      det: "<span>Cusmuy:</span> Casa de la Luna<br><span>Chunsua:</span> Casa del Sol<br><span>Cuca:</span> Escuela de sacerdotes<br><span>Pieza:</span> Ofrendatario cerámico en forma de chamán, Pasca (Cundinamarca)" + credito(FUENTE_BALSA)
    },
    {
      ...
      det: "<span>Rol:</span> Sacerdotes y guardianes de santuarios<br><span>Insignia:</span> Coronas de oro en forma de mitra<br><span>Pieza:</span> Figura votiva (tunjo), tumbaga, Belén de Chinauta (Cundinamarca)" + credito(FUENTE_MUISCA)
    },
];
