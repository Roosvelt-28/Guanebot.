...
//  PENDIENTE: falta conseguir/subir imagen a img/quimbaya/.
// ============================================================
...
export const piezasQuimbaya = [
    // ── SALA 1: ¿Quiénes eran los Quimbaya? ──────────────────────────────
    {
      ...
      det: "<span>Territorio:</span> valle medio del río Cauca<br><span>Departamentos actuales:</span> Quindío, Risaralda, Caldas<br><span>Fama:</span> orfebrería"
    },
    {
      ...
      det: "<span>Quimbaya Temprano:</span> 500 a.C.–700 d.C.<br><span>Quimbaya Tardío:</span> 1200–1600 d.C."
    },
    {
      ...
      det: "<span>Cultivos:</span> maíz, yuca, frutales<br><span>Organización:</span> cacicazgos"
    },
    {
      ...
      det: "<span>Siglo de contacto:</span> XVI<br><span>Reacción española:</span> asombro por la orfebrería"
    },
    ...
    // ── SALA 2: Maestros de la orfebrería ────────────────────────────────
    {
      ...
      det: "<span>Técnica:</span> cera perdida<br><span>Resultado:</span> piezas de una sola pieza fundida"
    },
    {
      ...
      det: "<span>Aleación:</span> tumbaga (oro + cobre)<br><span>Ventaja:</span> mayor resistencia y variedad de tonos"
    },
    {
      ...
      det: "<span>Motivo característico:</span> figuras humanas voluminosas<br><span>Adornos representados:</span> narigueras, orejeras, tocados"
    },
    {
      ...
      det: "<span>Reconocimiento:</span> arte precolombino de referencia mundial<br><span>Cualidad destacada:</span> precisión técnica y estética"
    },
    ...
    // ── SALA 3: El Tesoro Quimbaya ───────────────────────────────────────
    {
      ...
      det: "<span>Año del hallazgo:</span> 1890<br><span>Lugar:</span> cerca de Filandia, Quindío"
    },
    {
      ...
      det: "<span>Año del regalo:</span> 1892<br><span>Destino actual:</span> Museo de América, Madrid"
    },
    {
      ...
      det: "<span>Tema actual:</span> restitución de patrimonio arqueológico<br><span>Vigencia:</span> debate abierto hoy"
    },
    {
      ...
      det: "<span>Pieza icónica:</span> poporo antropomorfo<br><span>Valor:</span> equilibrio entre forma y función"
    },
    ...
    // ── SALA 4: Cerámica y vida cotidiana ────────────────────────────────
    {
      ...
      det: "<span>Pieza característica:</span> alcarraza de doble pico<span></span><br><span>Uso:</span> contener y servir líquidos"
    },
    {
      ...
      det: "<span>Economía:</span> agricultura y comercio regional<br><span>Bienes comerciados:</span> sal, algodón, orfebrería"
    },
    {
      ...
      det: "<span>Tipo de tumba:</span> pozo con cámara lateral<br><span>Ofrendas:</span> urnas de cerámica y piezas de oro"
    },
    {
      ...
      det: "<span>Ornamentos:</span> narigueras, orejeras, pectorales, diademas<br><span>Función:</span> símbolo de estatus social"
    },
    ...
    // ── SALA 5: Ritual, poporo y coca ────────────────────────────────────
    {
      ...
      det: "<span>Práctica:</span> mambeo de coca con cal<br><span>Significado:</span> estatus y comunicación espiritual"
    },
    {
      ...
      det: "<span>Objeto:</span> poporo<br><span>Significado:</span> paso a la vida adulta"
    },
    {
      ...
      det: "<span>Función del oro:</span> representación espiritual<br><span>Motivos:</span> antepasados, seres y fuerzas naturales"
    },
    {
      ...
      det: "<span>Región actual:</span> Eje Cafetero (Quindío, Risaralda, Caldas)<br><span>Continuidad:</span> identidad regional y artesanía"
    },
];
